...
export default function OrderFlowPanel() {
  ...
  const analysis = useMemo(() => {
    ...
    return { totalBuyVol, totalSellVol, buyPct, isAbsorption, isAggressiveSelling, isAggressiveBuying, isVolumeSpike, barCandles };
  }, [candles, currentIndex]);

  if (!analysis) return null;

  const { totalBuyVol, totalSellVol, buyPct, isAbsorption, isAggressiveSelling, isAggressiveBuying, isVolumeSpike, barCandles } = analysis;
